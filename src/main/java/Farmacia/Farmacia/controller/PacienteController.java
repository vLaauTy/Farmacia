...
public class PacienteController {
    ...
    public String guardarPaciente(@ModelAttribute("paciente") Paciente paciente, Model model, Authentication authentication) {
    ...
    public String guardarEdicionPaciente(@PathVariable("id") Long id, @ModelAttribute("paciente") Paciente paciente,
        ...
        // Si no es médico, validar DNI duplicado (médicos no pueden cambiar datos personales)
